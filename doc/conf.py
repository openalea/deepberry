...
htmlhelp_basename = "Deepberry_documentation"
...
man_pages = [(master_doc, "openalea.deepberry", "Deepberry Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "Deepberry",
        "Segmentation and time-lapse tracking of grapevine berries",
        "Miscellaneous",
    ),
]
